...
public void loadImages() {
    // Assuming that Board class is in the "snake" package and the images are in "snake.icons"
    URL urlApple = getClass().getResource("/snake/icons/apple.png");
